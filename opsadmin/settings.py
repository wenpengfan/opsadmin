...
config.read(os.path.join(BASE_DIR, 'opsadmin.conf'))
...
if redis_password:
    BROKER_URL = 'redis://:{0}@{1}:{2}/{3}'.format(redis_password, redis_host, redis_port, redis_db)
else:
...
BASE_LOG_DIR = '/opt/logs/opsadmin'
LOGGING = {
    'version': 1,
    ...
    'handlers': {
        'default': {
            ...
            'filename': os.path.join(BASE_LOG_DIR, "opsadmin.log"),
