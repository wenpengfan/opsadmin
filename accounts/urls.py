...
from accounts import user, role, permission, delegate, gldap
...
urlpatterns = [
    ...
    url(r'^delelist/$', delegate.delegate_list, name='delegate_list'),
    url(r'^deleadd/$', delegate.delegate_add, name='delegate_add'),
    url(r'^deledel/(?P<ids>\d+)/$', delegate.delegate_del, name='delegate_del'),
]
